...
class Parser {
  ...
  maybe_modifier() {
    ...
    this.next();
    const n2 = new Node("modif", "", this.current);
    this.next();
  ...
  bool_pat() {
    const n2 = new Node("bool", "pat", this.current);
    this.next();
    return n2;
  }
  char_pat() {
    const n2 = new Node("char", "pat", this.current);
    this.next();
    return n2;
  }
  str_pat() {
    const n2 = new Node("str", "pat", this.current);
    this.next();
    return n2;
  }
  int_pat() {
    const n2 = new Node("int", "pat", this.current);
    this.next();
    return n2;
  }
  float_pat() {
    const n2 = new Node("float", "pat", this.current);
    this.next();
    return n2;
  }
  list_pat() {
  ...
  enum_pat() {
    ...
    if (_pat) {
      const n2 = new Node("enum_pat", "pat", p);
      return n2;
    }
  }
  id_pat() {
    const id = this.current;
    this.next();
    const n2 = new Node("id", "pat", id);
    return n2;
  }
  req_body() {
    const stmts = this.stmts();
    const n2 = new Node("body", "body", stmts);
    return n2;
  }
  req_body_ret() {
  ...
  maybe_ret() {
    ...
    const n2 = new Node("return", "expr", expr);
    return n2;
  }
  maybe_break() {
    if (!this.is_break()) {
    ...
    this.next();
    const n2 = new Node("break", "stmt", null);
    return n2;
  }
  maybe_global_const() {
  ...
  maybe_receiver() {
    ...
    const n2 = new Node("receiver", "def", receiver);
  ...
  maybe_const() {
    ...
    const n2 = new Node("const", "stmt", asgmt);
    return n2;
  }
  maybe_let() {
    if (!this.is_let()) {
    ...
    const rhs = this.req_expr();
    const asgmt = new Asgmt(_pat2, t, rhs);
    const n2 = new Node("var", "stmt", asgmt);
    return n2;
  }
  req_expr() {
    const token = this.current;
  ...
  maybe_do_block() {
    ...
    this.req_close_curly();
    const n2 = new Node("do_block", "expr", stmts);
    return n2;
  }
  req_do_block() {
    const token = this.current;
  ...
  maybe_block() {
    ...
    this.req_end();
    const n2 = new Node("block", "expr", stmts);
    return n2;
  }
  maybe_semicolon() {
  ...
  req_call_args() {
    ...
    this.req_close_paren();
    const n2 = new Node("args", "expr", args);
    return n2;
  }
  maybe_lopr_prefix_postfix(expr, postfix_op) {
    ...
    if (expr.id === "prefix") {
      if (this.prec_uni(postfix_op) >= this.prec_uni(op)) {
        ...
        const n2 = new Node("postfix", "expr", postfix);
        this.next();
        return n2;
      }
    }
  ...
  maybe_op(lopr) {
    ...
    if (this.is_postfix_uni_op()) {
      ...
      const n2 = new Node("bin", "expr", bin);
      return n2;
    }
  }
  req_op(lopr) {
  ...
  maybe_afn(els) {
    ...
    if (this.is_thick_arrow()) {
      ...
      const n2 = new Node("afn", "expr", _afn);
      return n2;
    }
  }
        ...
        if (expr) {
          ...
          if (this.is_comma()) {
            ...
            if (afn) {
              ...
              const n2 = new Node("tuple", "expr", tuple);
              return n2;
            }
          } else {
            this.req_close_paren();
  ...
  maybe_prefix_uni_op() {
    if (this.is_prefix_uni_op()) {
      ...
      const n2 = new Node("prefix", "expr", prefix);
      return n2;
    }
  }
  maybe_literal() {
  ...
  maybe_bool() {
    if (this.is_bool()) {
      const n2 = new Node("bool", "expr", this.current);
      this.next();
      return n2;
    }
  }
  maybe_char() {
    if (this.is_char()) {
      const n2 = new Node("char", "expr", this.current);
      this.next();
      return n2;
    }
  }
  maybe_str() {
    if (this.is_str()) {
      const n2 = new Node("str", "expr", this.current);
      this.next();
      return n2;
    }
  }
  maybe_int() {
    if (this.is_int()) {
      ...
      const n2 = new Node("int", "expr", [num, suffix]);
      return n2;
    }
  }
  maybe_float() {
    if (this.is_float()) {
      ...
      const n2 = new Node("float", "expr", [num, suffix]);
      return n2;
    }
  }
  maybe_list() {
  ...
  maybe_call(id) {
    ...
    const n2 = new Node("call", "expr", [id, args, children]);
    return n2;
  }
  req_ref() {
    const id = this.current;
    this.next();
    const n2 = new Node("ref", "expr", id);
    return n2;
  }
  maybe_call_or_ref() {
    if (this.is_id()) {
  ...
  maybe_when() {
    ...
    const n2 = new Node("when", "expr", _when);
    return n2;
  }
  maybe_prim() {
  ...
  maybe_fn() {
    ...
    if (_fn && contains$2(["main", "بدء"], _fn.v.name.v[1])) {
      const n2 = new Node("main", "fn", _fn.v);
      return n2;
    } else {
      const n2 = new Node("fn", "fn", _fn.v);
      return n2;
    }
  }
  maybe_use() {
    ...
    const n2 = new Node("use", "stmt", path);
    this.ast.push(n2);
    return true;
  }
  maybe_optional() {
  ...
  maybe_struct() {
    ...
    const n2 = new Node("struct", "def", _t);
    this.ast.push(n2);
    return true;
  }
  maybe_enum() {
  ...
  implicit_return(_stmts) {
    ...
    if (last.t === "expr") {
      const n2 = new Node("iret", "expr", last);
      return replace(_stmts, last_index, n2);
    }
  }
}
class Semantic {
...
function is_maghrib_num$1(n2) {
  return contains$1(MAGHRIB_DIGIT$1, n2[0]);
}
function to_maghrib_num$1(n2) {
  if (!is_maghrib_num$1(n2)) {
    let v2 = "";
    let i = 0;
    while (i < n2.length) {
      const c = n2[i];
...
function is_maghrib_num(n2) {
  return contains(MAGHRIB_DIGIT, n2[0]);
}
function to_maghrib_num(n2) {
  if (!is_maghrib_num(n2)) {
    let v2 = "";
    let i = 0;
    while (i < n2.length) {
      const c = n2[i];
